...
const HeaderSection = () => (
  ...
  >
    <h2 className="text-2xl font-bold text-blue-900">
      THÔNG BÁO NGHỈ LỄ QUỐC KHÁNH 02 THÁNG 09
      <div
        style={{
          display: "flex",
          justifyContent: "center",
  ...
  <div>
    {renderAccessContent(
      `
        ...
        <br />- Thời gian nghỉ: Thứ Năm ngày 18/04/2024.
        <br />- Thời gian làm việc trở lại: Thứ Sáu, ngày 19/04/2024.
        <br />Kính chúc Quý khách cùng gia đình có kỳ nghỉ lễ hạnh phúc và an lành.
