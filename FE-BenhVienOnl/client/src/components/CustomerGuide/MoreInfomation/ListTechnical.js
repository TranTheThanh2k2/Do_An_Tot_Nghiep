...
const AccessSection = () => (
  <div>
    {renderAccessContent(
      ...
      "DANH MỤC KỸ THUẬT",
      `
        Phòng khám Bệnh viện được phê duyệt danh mục kỹ thuật trong khám chữa bệnh theo quyết định số 467/QĐ-SYT ngày 26 tháng 5 năm 2020 của Sở Y tế. Phòng khám đa khoa Bệnh viện chịu trách nhiệm chuyên môn tại địa chỉ 20-22 Dương Quang Trung, Phường 12, Quận 10
        <br />Xem chi tiết: ...
    `
    )}
  </div>
